...
namespace PeopleManagmentSystem_API.Services
{
    public class ProjectService : IProjectService
    {
        ...
        public async Task<List<PerformanceProject.Shared.Models.Task>> GetTasksAsync(ObjectId id)
        {
            var project = await _projects.Find(p => p.Id == id).FirstOrDefaultAsync();
            if (project == null)
            {
        ...
        // Tasks
        public async Task AddTaskAsync(ObjectId projectId, PerformanceProject.Shared.Models.Task task)
        {
            var project = await GetAsync(projectId);
        ...
        public async Task UpdateTaskAsync(ObjectId projectId, PerformanceProject.Shared.Models.Task task)
        {
            var project = await GetAsync(projectId);
