...
namespace PeopleManagmentSystem_API
{
    ...
    {
        /// <summary>
        /// model input class for TaskClassification.
        /// </summary>
        ...
        /// <summary>
        /// model output class for TaskClassification.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            [ColumnName(@"Task Title")]
            public float[] Task_Title { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("TaskClassification.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Skills");
            if (labelColumn == null)
            {
                throw new Exception("Skills column not found. Make sure the name searched for matches the name in the schema.");
            }
